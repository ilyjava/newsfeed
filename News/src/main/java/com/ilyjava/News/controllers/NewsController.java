package com.ilyjava.News.controllers;
...
public class NewsController {
	...
	public String searchNews(@RequestParam("query") String query, @RequestParam("search_area") String area, Model model) {
		...
		String[] queryBuffer = query.trim().split(" "); 
		Map<Integer, Integer> newsMap = new HashMap<Integer, Integer>(); 
		...
		List<Entry<Integer, Integer>> list = new ArrayList<Entry<Integer, Integer>>(newsMap.entrySet());
